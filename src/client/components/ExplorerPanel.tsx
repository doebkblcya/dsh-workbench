/**
 * The Files body: the persistent filename search at the top (150ms debounced;
 * a hit click REVEALS the file in the tree — expand ancestors + select — never
 * opens preview), and the lazy file tree (34px rows, full-row expand/collapse,
 * 16px icons). The tab bar + collapse chevron live in WorkbenchPanel.
 *
 ...
 * @module dsh-workbench/client/components/ExplorerPanel
 */
...
/**
 * The Files body (the tab bar and collapse chevron live in WorkbenchPanel).
 * @param stores - the panel store bundle.
 */
export function ExplorerPanel({ stores }: { stores: PanelStores }): JSX.Element {
